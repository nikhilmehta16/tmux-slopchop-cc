...
// Standalone replacement for Pi's `getAgentDir`. Points at the same Pi agent
// directory Pi uses (`$PI_AGENT_DIR`, else `~/.pi/agent`) so an existing
// slopchop.json shortcut config is picked up without changes.
